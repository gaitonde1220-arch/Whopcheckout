 ...
 * Description:       Whop Checkout for WooCommerce — one-click Connect, setup wizard, and webhook-verified payments.
 * Version:           4.0.4
...
function whop_gw_bootstrap(): void {
	...
	require_once WHOP_GW_PLUGIN_PATH . 'includes/class-whop-connect.php';
...
function whop_gw_admin_configuration_notices(): void {
	...
	if ( ! Whop_GW_Helper::has_credentials() ) {
		$issues[] = __( 'Whop is not connected. Open Whop Checkout to connect or run the Setup Wizard.', 'whop-gateway-wc' );
